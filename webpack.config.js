...
Encore
    ...
    .addEntry('js/necropolis', './assets/js/necropolis.js')
    .addEntry('js/bouquetBuilder', './assets/js/bouquetBuilder.js')
    ...
    .addStyleEntry('css/necropolis', './assets/css/necropolis.scss')
    .addStyleEntry('css/necropolis-admin', './assets/css/necropolis_admin.scss')
